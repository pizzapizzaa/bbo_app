...
export const ADDONS: AddonDef[] = [
  { name: 'Chalk Ball',          price:  75_000, rental: false },
  { name: 'Liquid Chalk Rental', price:  25_000, rental: true  },
  { name: 'Shoes Rental',        price:  20_000, rental: true  },
  { name: 'Chalk Bag Rental',    price:  15_000, rental: true  },
  { name: 'Vitani Dasani',       price:   8_000, rental: false },
  { name: 'Ionlife',             price:  10_000, rental: false },
  { name: 'Pocari',              price:  18_000, rental: false },
  { name: 'Liquid Chalk Small',  price:  70_000, rental: false },
  { name: 'Liquid Chalk Big',    price: 150_000, rental: false },
  { name: 'Socks',               price:  10_000, rental: false },
];
